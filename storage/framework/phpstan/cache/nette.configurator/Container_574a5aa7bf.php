...
class Container_574a5aa7bf extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_574a5aa7bf $container)
			{
	...
	public function createServiceContainer(): Container_574a5aa7bf
	{
		return $this;
	}
