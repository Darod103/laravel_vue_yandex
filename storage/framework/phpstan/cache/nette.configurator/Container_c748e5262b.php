...
class Container_c748e5262b extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_c748e5262b $container)
			{
	...
	public function createServiceContainer(): Container_c748e5262b
	{
		return $this;
	}
