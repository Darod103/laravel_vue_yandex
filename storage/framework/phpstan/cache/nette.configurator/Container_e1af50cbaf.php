...
class Container_e1af50cbaf extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e1af50cbaf $container)
			{
	...
	public function createServiceContainer(): Container_e1af50cbaf
	{
		return $this;
	}
