...
class Container_fe6a2d86d6 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_fe6a2d86d6 $container)
			{
	...
	public function createServiceContainer(): Container_fe6a2d86d6
	{
		return $this;
	}
