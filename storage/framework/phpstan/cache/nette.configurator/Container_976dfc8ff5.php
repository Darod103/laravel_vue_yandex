...
class Container_976dfc8ff5 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	protected $wiring = [
		...
		'PHPStan\Reflection\PropertiesClassReflectionExtension' => [['0236', '0704', '0705', '0707']],
		...
		'PHPStan\Collectors\Collector' => [1 => ['0681', '0682', '0683', '0684', '0685', '0686', '0687', '0688', '0689']],
		...
		'PHPStan\Reflection\MethodsClassReflectionExtension' => [['0703', '0706', '0708', '0709']],
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_976dfc8ff5 $container)
			{
	...
	public function createServiceContainer(): Container_976dfc8ff5
	{
		return $this;
	}
